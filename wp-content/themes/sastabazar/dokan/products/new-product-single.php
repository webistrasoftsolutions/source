...
if ( !isset( $post->ID ) && ! isset( $_GET['product_id'] ) ) {
    wp_die( esc_html__( 'Access Denied, No product found', 'sanzo' ) );
}

if( isset( $post->ID ) && $post->ID && $post->post_type == 'product' ) {

    if ( $post->post_author != get_current_user_id() ) {
        wp_die( esc_html__( 'Access Denied', 'sanzo' ) );
    }
    ...
    <div class="dokan-dashboard-content dokan-product-edit">
        ...
        <header class="dokan-dashboard-header dokan-clearfix">
            <h1 class="entry-title">
                <?php esc_html_e( 'Edit Product', 'sanzo' ); ?>
                ...
                <?php if ( $post->post_status == 'publish' ) { ?>
                    <span class="dokan-right">
                        <a class="dokan-btn dokan-btn-theme dokan-btn-sm" href="<?php echo get_permalink( $post->ID ); ?>" target="_blank"><?php esc_html_e( 'View Product', 'sanzo' ); ?></a>
                    </span>
                <?php } ?>

                <?php if ( $_visibility == 'hidden' ) { ?>
                    <span class="dokan-right dokan-label dokan-label-default dokan-product-hidden-label"><i class="fa fa-eye-slash"></i> <?php esc_html_e( 'Hidden', 'sanzo' ); ?></span>
                <?php } ?>
            </h1>
        </header><!-- .entry-header -->
        ...
        <div class="product-edit-new-container product-edit-container">
            <?php if ( Dokan_Template_Products::$errors ) { ?>
                <div class="dokan-alert dokan-alert-danger">
                    ...
                    <?php foreach ( Dokan_Template_Products::$errors as $error) { ?>
                        <strong><?php esc_html_e( 'Error!', 'sanzo' ); ?></strong> <?php echo $error ?>.<br>
                    <?php } ?>
                </div>
            <?php } ?>
            ...
            <?php if ( isset( $_GET['message'] ) && $_GET['message'] == 'success') { ?>
                <div class="dokan-message">
                    ...
                    <strong><?php esc_html_e( 'Success!', 'sanzo' ); ?></strong> <?php esc_html_e( 'The product has been saved successfully.', 'sanzo' ); ?>

                    <?php if ( $post->post_status == 'publish' ) { ?>
                        <a href="<?php echo get_permalink( $post_id ); ?>" target="_blank"><?php esc_html_e( 'View Product &rarr;', 'sanzo' ); ?></a>
                    <?php } ?>
                </div>
            <?php } ?>
                ...
                if ( dokan_is_seller_enabled( get_current_user_id() ) ) { ?>
                    <form class="dokan-product-edit-form" role="form" method="post">
                        ...
                        <div class="dokan-form-top-area">
                            ...
                            <div class="content-half-part dokan-product-meta">
                                ...
                                <div class="dokan-form-group">
                                    ...
                                    <label for="post_title" class="form-label"><?php esc_html_e( 'Title', 'sanzo' ); ?></label>
                                    <?php dokan_post_input_box( $post_id, 'post_title', array( 'placeholder' => esc_html__( 'Product name..', 'sanzo' ), 'value' => $post_title ) ); ?>
                                    <div class="dokan-product-title-alert dokan-hide">
                                        <?php esc_html_e( 'Please enter product title!', 'sanzo' ); ?>
                                    </div>
                                </div>
                                ...
                                <?php if ( is_array( $product_types ) ): ?>
                                    <div class="dokan-form-group">
                                        <label for="product_type" class="form-label"><?php esc_html_e( 'Product Type', 'sanzo' ); ?> <i class="fa fa-question-circle tips" aria-hidden="true" data-title="<?php esc_html_e( 'Choose Variable if your product has multiple attributes - like sizes, colors, quality etc', 'sanzo' ); ?>"></i></label>
                                ...
                                <div class="dokan-form-group dokan-product-type-container show_if_simple">
                                    <div class="content-half-part downloadable-checkbox">
                                        <label>
                                            <input type="checkbox" <?php checked( $is_downloadable, true ); ?> class="_is_downloadable" name="_downloadable" id="_downloadable"> <?php esc_html_e( 'Downloadable', 'sanzo' ); ?> <i class="fa fa-question-circle tips" aria-hidden="true" data-title="<?php esc_html_e( 'Downloadable products give access to a file upon purchase.', 'sanzo' ); ?>"></i>
                                        </label>
                                    </div>
                                    <div class="content-half-part virtual-checkbox">
                                        <label>
                                            <input type="checkbox" <?php checked( $is_virtual, true ); ?> class="_is_virtual" name="_virtual" id="_virtual"> <?php esc_html_e( 'Virtual', 'sanzo' ); ?> <i class="fa fa-question-circle tips" aria-hidden="true" data-title="<?php esc_html_e( 'Virtual products are intangible and aren\'t shipped.', 'sanzo' ); ?>"></i>
                                        </label>
                                    </div>
                                ...
                                <div class="show_if_simple dokan-clearfix">
                                    ...
                                    <div class="dokan-form-group dokan-clearfix dokan-price-container">
                                        ...
                                        <div class="content-half-part regular-price">
                                            <label for="_regular_price" class="form-label"><?php esc_html_e( 'Price', 'sanzo' ); ?></label>

                                            <div class="dokan-input-group">
                                                <span class="dokan-input-group-addon"><?php echo get_woocommerce_currency_symbol(); ?></span>
                                                <?php dokan_post_input_box( $post_id, '_regular_price', array( 'placeholder' => esc_html__( '0.00', 'sanzo' ) ), 'number' ); ?>
                                            </div>
                                        </div>

                                        <div class="content-half-part sale-price">
                                            <label for="_sale_price" class="form-label">
                                                <?php esc_html_e( 'Discounted Price', 'sanzo' ); ?>
                                                <a href="#" class="sale_schedule <?php echo ($show_schedule ) ? 'dokan-hide' : ''; ?>"><?php esc_html_e( 'Schedule', 'sanzo' ); ?></a>
                                                <a href="#" class="cancel_sale_schedule <?php echo ( ! $show_schedule ) ? 'dokan-hide' : ''; ?>"><?php esc_html_e( 'Cancel', 'sanzo' ); ?></a>
                                            </label>

                                            <div class="dokan-input-group">
                                                <span class="dokan-input-group-addon"><?php echo get_woocommerce_currency_symbol(); ?></span>
                                                <?php dokan_post_input_box( $post_id, '_sale_price', array( 'placeholder' => esc_html__( '0.00', 'sanzo' ) ), 'number' ); ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sale_price_dates_fields dokan-clearfix dokan-form-group <?php echo ( ! $show_schedule ) ? 'dokan-hide' : ''; ?>">
                                        <div class="content-half-part from">
                                            <div class="dokan-input-group">
                                                <span class="dokan-input-group-addon"><?php esc_html_e( 'From', 'sanzo' ); ?></span>
                                        ...
                                        <div class="content-half-part to">
                                            <div class="dokan-input-group">
                                                <span class="dokan-input-group-addon"><?php esc_html_e( 'To', 'sanzo' ); ?></span>
                                ...
                                <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                    <div class="dokan-form-group">
                                        <label for="product_cat" class="form-label"><?php esc_html_e( 'Category', 'sanzo' ); ?></label>
                                        <?php
                                        $product_cat = -1;
                                        $term = array();
                                        ...
                                        $category_args =  array(
                                            'show_option_none' => esc_html__( '- Select a category -', 'sanzo' ),
                                            'hierarchical'     => 1,
                                            'hide_empty'       => 0,
                                            'name'             => 'product_cat',
                                            'id'               => 'product_cat',
                                    ...
                                    ?>
                                        <div class="dokan-product-cat-alert dokan-hide">
                                            <?php esc_html_e('Please choose a category!', 'sanzo'); ?>
                                        </div>
                                    </div>
                                <?php elseif ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'multiple' ): ?>
                                    <div class="dokan-form-group">
                                        ...
                                        $drop_down_category = wp_dropdown_categories( array(
                                            'show_option_none' => esc_html__( '', 'sanzo' ),
                                            'hierarchical'     => 1,
                                            'hide_empty'       => 0,
                                            'name'             => 'product_cat[]',
                                            'id'               => 'product_cat',
                                        ...
                                        echo str_replace( '<select', '<select data-placeholder="'.esc_html__( 'Select product category', 'sanzo' ).'" multiple="multiple" ', $drop_down_category );
                                        ?>
                                    </div>
                                <?php endif; ?>

                                <div class="dokan-form-group">
                                    <label for="product_tag" class="form-label"><?php esc_html_e( 'Tags', 'sanzo' ); ?></label>
                                    <?php
                                    ...
                                    echo str_replace( '<select', '<select data-placeholder="'.esc_html__( 'Select product tags', 'sanzo' ).'" multiple="multiple" ', $drop_down_tags );
                            ...
                            <div class="content-half-part featured-image">
                                ...
                                <div class="dokan-feat-image-upload dokan-new-product-featured-img">
                                    ...
                                    <div class="instruction-inside<?php echo $instruction_class; ?>">
                                        ...
                                        <a href="#" class="dokan-feat-image-btn btn btn-sm"><?php esc_html_e( 'Upload a product cover image', 'sanzo' ); ?></a>
                                    </div>
                                    ...
                                    <div class="dokan-side-body" id="dokan-product-images">
                                        <div id="product_images_container">
                                            <ul class="product_images dokan-clearfix">
                                                ...
                                                ?>
												<li class="add-image add-product-images tips" data-title="<?php esc_attr_e( 'Add gallery image', 'sanzo' ); ?>">
                        ...
                        <div class="dokan-product-short-description">
                            <label for="post_excerpt" class="form-label"><?php esc_html_e( 'Short Description', 'sanzo' ); ?></label>
                        ...
                        <div class="dokan-product-description">
                            <label for="post_content" class="form-label"><?php esc_html_e( 'Description', 'sanzo' ); ?></label>
                        ...
                        <div class="dokan-product-inventory dokan-edit-row">
                            <div class="dokan-section-heading" data-togglehandler="dokan_product_inventory">
                                <h2><i class="fa fa-cubes" aria-hidden="true"></i> <?php esc_html_e( 'Inventory', 'sanzo' ); ?></h2>
                                <p><?php esc_html_e( 'Manage inventory for this product.', 'sanzo' ); ?></p>
                            ...
                            <div class="dokan-section-content">
                                ...
                                <div class="content-half-part dokan-form-group hide_if_variation">
                                    <label for="_sku" class="form-label"><?php esc_html_e( 'SKU', 'sanzo' ); ?> <span><?php esc_html_e( '(Stock Keeping Unit)', 'sanzo' ); ?></span></label>
                                    <?php dokan_post_input_box( $post_id, '_sku' ); ?>
                                </div>

                                <div class="content-half-part hide_if_variation">
                                    <label for="_stock_status" class="form-label"><?php esc_html_e( 'Stock Status', 'sanzo' ); ?></label>

                                    <?php dokan_post_input_box( $post_id, '_stock_status', array( 'options' => array(
                                        'instock'     => esc_html__( 'In Stock', 'sanzo' ),
                                        'outofstock' => esc_html__( 'Out of Stock', 'sanzo' ),
                                    ) ), 'select' ); ?>
                                </div>
                                ...
                                <div class="dokan-form-group hide_if_variation">
                                    <?php dokan_post_input_box( $post_id, '_manage_stock', array( 'label' => esc_html__( 'Enable product stock management', 'sanzo' ) ), 'checkbox' ); ?>
                                </div>

                                <div class="show_if_stock dokan-stock-management-wrapper dokan-form-group dokan-clearfix">

                                    <div class="content-half-part hide_if_variation">
                                        <label for="_stock" class="form-label"><?php esc_html_e( 'Quantity', 'sanzo' ); ?></label>
                                        <input type="number" class="dokan-form-control" name="_stock" placeholder="<?php esc_html__( '1', 'sanzo' ); ?>" value="<?php echo wc_stock_amount( $_stock ); ?>" min="0" step="1">
                                    </div>

                                    <div class="content-half-part hide_if_variation last-child">
                                        <label for="_backorders" class="form-label"><?php esc_html_e( 'Allow Backorders', 'sanzo' ); ?></label>

                                        <?php dokan_post_input_box( $post_id, '_backorders', array( 'options' => array(
                                            'no'     => esc_html__( 'Do not allow', 'sanzo' ),
                                            'notify' => esc_html__( 'Allow but notify customer', 'sanzo' ),
                                            'yes'    => esc_html__( 'Allow', 'sanzo' )
                                        ) ), 'select' ); ?>
                                    </div>
                                    <div class="dokan-clearfix"></div>
                                </div><!-- .show_if_stock -->
                                ...
                                <div class="dokan-form-group">
                                    <label class="" for="_sold_individually">
                                        ...
                                        <?php esc_html_e( 'Allow only one quantity of this product to be bought in a single order', 'sanzo' ) ?>
                                    </label>
                                </div>
                        ...
                        <div class="dokan-download-options dokan-edit-row dokan-clearfix show_if_downloadable">
                            <div class="dokan-section-heading" data-togglehandler="dokan_download_options">
                                <h2><i class="fa fa-download" aria-hidden="true"></i> <?php esc_html_e( 'Downloadable Options', 'sanzo' ); ?></h2>
                                <p><?php esc_html_e( 'Configure your downloadable product settings', 'sanzo' ); ?></p>
                                <a href="#" class="dokan-section-toggle">
                                    <i class="fa fa-sort-desc fa-flip-vertical" aria-hidden="true"></i>
                                </a>
                                <div class="dokan-clearfix"></div>
                                    ...
                                    <div class="dokan-side-body dokan-download-wrapper">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th colspan="3">
                                                        ...
                                                        ?>"><?php esc_html_e( 'Add File', 'sanzo' ); ?></a>
                                                    </th>
                                                </tr>
                                            </tfoot>
                                            <thead>
                                                <tr>
                                                    <th><?php esc_html_e( 'Name', 'sanzo' ); ?> <span class="tips" title="<?php esc_html_e( 'This is the name of the download shown to the customer.', 'sanzo' ); ?>">[?]</span></th>
                                                    <th><?php esc_html_e( 'File URL', 'sanzo' ); ?> <span class="tips" title="<?php esc_html_e( 'This is the URL or absolute path to the file which customers will get access to.', 'sanzo' ); ?>">[?]</span></th>
                                                    <th><?php esc_html_e( 'Action', 'sanzo' ); ?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                        ...
                                        <div class="dokan-clearfix">
                                            <div class="content-half-part">
                                                <label for="_download_limit" class="form-label"><?php esc_html_e( 'Download Limit', 'sanzo' ); ?></label>
                                                <?php dokan_post_input_box( $post_id, '_download_limit', array( 'placeholder' => esc_html__( 'e.g. 4', 'sanzo' ) ) ); ?>
                                            </div><!-- .content-half-part -->

                                            <div class="content-half-part">
                                                <label for="_download_expiry" class="form-label"><?php esc_html_e( 'Download Expiry', 'sanzo' ); ?></label>
                                                <?php dokan_post_input_box( $post_id, '_download_expiry', array( 'placeholder' => esc_html__( 'Number of days', 'sanzo' ) ) ); ?>
                                            </div><!-- .content-half-part -->
                                        </div>
                        ...
                        <div class="dokan-other-options dokan-edit-row dokan-clearfix">
                            <div class="dokan-section-heading" data-togglehandler="dokan_other_options">
                                <h2><i class="fa fa-cog" aria-hidden="true"></i> <?php esc_html_e( 'Other Options', 'sanzo' ); ?></h2>
                                <p><?php esc_html_e( 'Set your extra product options', 'sanzo' ); ?></p>
                                <a href="#" class="dokan-section-toggle">
                                    <i class="fa fa-sort-desc fa-flip-vertical" aria-hidden="true"></i>
                                </a>
                                <div class="dokan-clearfix"></div>
                            ...
                            <div class="dokan-section-content">
                                <div class="dokan-form-group content-half-part">
                                    <label for="post_status" class="form-label"><?php esc_html_e( 'Product Status', 'sanzo' ); ?></label>
                                    <?php if ( $post_status != 'pending' ) { ?>
                                        <?php $post_statuses = apply_filters( 'dokan_post_status', array(
                                            'publish' => esc_html__( 'Online', 'sanzo' ),
                                            'draft'   => esc_html__( 'Draft', 'sanzo' )
                                        ), $post ); ?>
                                ...
                                <div class="dokan-form-group content-half-part">
                                    <label for="_visibility" class="form-label"><?php esc_html_e( 'Visibility', 'sanzo' ); ?></label>
                                    <?php dokan_post_input_box( $post_id, '_visibility', array( 'options' => array(
                                        'visible' => esc_html__( 'Catalog or Search', 'sanzo' ),
                                        'catalog' => esc_html__( 'Catalog', 'sanzo' ),
                                        'search'  => esc_html__( 'Search', 'sanzo' ),
                                        'hidden'  => esc_html__( 'Hidden', 'sanzo')
                                    ) ), 'select' ); ?>
                                </div>
                                ...
                                <div class="dokan-form-group">
                                    <label for="_purchase_note" class="form-label"><?php esc_html_e( 'Purchase Note', 'sanzo' ); ?></label>
                                    <?php dokan_post_input_box( $post_id, '_purchase_note', array( 'placeholder' => esc_html__( 'Customer will get this info in their order email', 'sanzo' ) ), 'textarea' ); ?>
                                </div>

                                <div class="dokan-form-group">
                                    <?php $_enable_reviews = ( $post->comment_status == 'open' ) ? 'yes' : 'no'; ?>
                                    <?php dokan_post_input_box( $post_id, '_enable_reviews', array('value' => $_enable_reviews, 'label' => esc_html__( 'Enable product reviews', 'sanzo' ) ), 'checkbox' ); ?>
                                </div>
