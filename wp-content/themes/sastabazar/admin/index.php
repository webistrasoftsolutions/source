 ...
 * @since 1.0.0
 */
if (is_admin() && isset($_GET['activated'] ) && $pagenow == "themes.php" ) add_action('admin_head', 'sanzo_of_option_setup');
add_action('admin_init','sanzo_optionsframework_admin_init');
add_action('admin_menu', 'sanzo_optionsframework_add_admin');
 ...
 * @since 1.0.0
 */
add_action('wp_ajax_sanzo_of_ajax_post_action', 'sanzo_of_ajax_callback');
